...
- (void)viewDidLoad {
    ...
    //    if(!_doneButtonImage) {
    [_printButton setTitleColor:[UIColor colorWithWhite:0.9 alpha:0.9] forState:UIControlStateNormal|UIControlStateHighlighted];
    [_printButton setTitle:IDMPhotoBrowserLocalizedStrings(@"Print") forState:UIControlStateNormal];
    [_printButton.titleLabel setFont:[UIFont boldSystemFontOfSize:11.0f]];
    [_printButton setBackgroundColor:[UIColor colorWithWhite:0.1 alpha:0.5]];
...
- (void)viewWillLayoutSubviews {
    ...
    _printButton.frame = [self frameForPrintButtonAtOrientation:currentOrientation];
...
- (CGRect)frameForPrintButtonAtOrientation:(UIInterfaceOrientation)orientation {
    CGRect screenBound = self.view.bounds;
    CGFloat screenWidth = screenBound.size.width;
